...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    ...
    >
      ...
      {/* Timeline Entries */}
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 md:mt-[-40px]">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            ...
            <h2 className={`${TITLE_TAILWIND_CLASS} mt-2 pb-3 font-semibold tracking-tight dark:text-white text-gray-900`}>
              {item.job}
            </h2>
